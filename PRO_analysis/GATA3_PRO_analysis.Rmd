...
cutadapt -m 18 -O 1 -a GATCGTCGGACTGTAGAACTCTGAAC $file_PE2 -o PE2_test_noadap1.fastq --too-short-output test_PE2_short1.fastq > PE1_test_cutadapt1.txt
...
cutadapt -m 18 -O 10 -a GATCGTCGGACTGTAGAACTCTGAAC PE2_test_noadap1.fastq -o PE2_test_noadap2.fastq --too-short-output test_PE2_short2.fastq > PE1_test_cutadapt2.txt


wc -l PE1_test_noadap1.fastq | awk '{print $1/4}'
wc -l PE2_test_noadap1.fastq | awk '{print $1/4}'
wc -l PE1_test_noadap2.fastq | awk '{print $1/4}'
wc -l PE2_test_noadap2.fastq | awk '{print $1/4}'
```
