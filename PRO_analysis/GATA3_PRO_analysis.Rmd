...
2. obtain gene annotations use get.largest.interval(); \
...
4. based on above distribution, choose threshold or specify a gene to be cut off
```{r engine='R', eval=F, echo=TRUE}
den.cut = -8
cnt.cut = 1
...
7. get TTS coordinates\
find TTS search regions use get.end.intervals() \
identifying TTS use get.TTS() \
```{r engine='R', eval=F, echo=TRUE}
# get TTS intervals
add.to.end = 100000
fraction.end = 0.2
