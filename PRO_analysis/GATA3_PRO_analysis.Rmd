...
cat *_QC_metrics.txt | awk '!x[$0]++' > project_QC_metrics.txt m,              
...
bw.plot.lattice <- function(df.bw, filename = 'file.name', 
         title.main = "Differential PRO-seq Expression",
         fill.col = c("red",  "blue")){
pdf(paste("BW_plot_", filename, "_response.pdf", sep=''),  width=2, height=4)
...
bw.plot.lattice(bw.df.E2, filename = 'control_E2_vs_control_NoE2', 
         title.main = "differentially expressed gene under E2 treatment (FDR=0.1)",
         fill.col = c("red",  "blue"))
```
