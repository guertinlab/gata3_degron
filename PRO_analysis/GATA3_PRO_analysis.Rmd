...
done 2>&1 | tee -a readsize_log.txt
...
```{r  out.width = "100%", echo=F, fig.align = "center", fig.cap="GATA3 degron PRO seq QC metrics"}
library(knitr)
...
ma.plot.jpeg.lattice <- function(ma.df, filename = 'file.name', 
         title.main = "Differential PRO-seq Expression",
         col = c("grey90",  "grey60", "#ce228e" , "#2290cf"))
  {
  jpeg(paste("MA_plot_", filename, "_response.jpeg", sep=''), quality=100, height=2500, width=3000, pointsize=8, res=600)
  # pdf(paste("MA_plot_", filename, ".pdf", sep=''), width=4, height=4)
  print(xyplot(ma.df$log2FoldChange ~ log(ma.df$baseMean, base=10),
               groups=ma.df$treatment,
               col= col,
...
In this PRO exp, we have 4 levels, here we define the sample conditions based on our experiment treatment set the levels.
```{r engine='R', eval=F, echo=TRUE}
...
#library(knitr)
knitr::include_graphics("./PCA_GATA3_PRO_control_sub.pdf") 
```
...
#library(knitr)
knitr::include_graphics("./PCA_GATA3_PRO_dTAG_sub.pdf") 
```
...
ma.plot.jpeg.lattice(ma.df, filename='control_E2_vs_control_NoE2', title.main="Differential Expression (FDR <0.1)", col=c("grey90","grey60", "red", "blue"))
...
#library(knitr)
knitr::include_graphics("./MA_plot_control_E2_vs_control_NoE2_response.jpeg") 
```
...
ma.plot.jpeg.lattice(ma.df, filename='dTAGV1_E2_vs_dTAGV1_NoE2', title.main="Differential Expression (FDR <0.1)", col=c("grey90","grey60", "red", "blue"))
...
```{r  out.width = "100%", echo=F, fig.align = "center", fig.cap="MA plot"}
#library(knitr)
knitr::include_graphics("./MA_plot_dTAGV1_E2_vs_dTAGV1_NoE2_response.jpeg") 
```
...
ma.plot.jpeg.lattice(ma.df, filename='dTAGV1_E2_vs_control_E2', title.main="Differential Expression (FDR <0.1)", col=c("grey90","grey60", "red", "blue"))
...
```{r  out.width = "100%", echo=F, fig.align = "center", fig.cap="MA plot"}
#library(knitr)
knitr::include_graphics("./MA_plot_dTAGV1_E2_vs_control_E2_response.jpeg") 
```
...
ma.plot.jpeg.lattice(ma.df, filename='dTAGV1_NoE2_vs_control_NoE2', title.main="Differential Expression (FDR <0.01)", col=c("grey90","grey60", "red", "blue"))
...
```{r  out.width = "100%", echo=F, fig.align = "center", fig.cap="MA plot"}
#library(knitr)
knitr::include_graphics("./MA_plot_dTAGV1_NoE2_vs_control_NoE2_response.jpeg") 
```
