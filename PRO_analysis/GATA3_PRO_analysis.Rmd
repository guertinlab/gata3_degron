...
In the above PCA, we can see a clear separation between libraries with or without dTAG treatment (if GATA3 is degraded). We can further seprate the libraries to two groups and check if there is also clear separation bewteen E2 treated groups.
```{r engine='R', eval=F, echo=TRUE}
#PCA for experiments
plotPCA(rld)
...
#library(knitr)
knitr::include_graphics("./MA_plot_control_E2_vs_control_NoE2_response.pdf") 
```
...
```{r  out.width = "100%", echo=F, fig.align = "center", fig.cap="MA plot"}
#library(knitr)
knitr::include_graphics("./MA_plot_dTAGV1_E2_vs_dTAGV1_NoE2_response.pdf") 
```
...
```{r  out.width = "100%", echo=F, fig.align = "center", fig.cap="MA plot"}
#library(knitr)
knitr::include_graphics("./MA_plot_dTAGV1_E2_vs_control_E2_response.pdf") 
```
...
```{r  out.width = "100%", echo=F, fig.align = "center", fig.cap="MA plot"}
#library(knitr)
knitr::include_graphics("./MA_plot_dTAGV1_NoE2_vs_control_NoE2_response.pdf") 
```
